...
export default function VideoHero() {
  return (
    <section id="videohero" className="relative w-full h-[50vh] sm:h-[60vh] md:h-[70vh] lg:h-[80vh] overflow-hidden bg-black">
   <video
...
/>
      ...
      <div className="relative z-10 h-full flex items-center justify-center px-4 sm:px-6">
        ...
        >
          <h2 className="text-white text-2xl sm:text-3xl md:text-5xl font-serif font-bold mb-2 sm:mb-3">Crafted for Motion</h2>
